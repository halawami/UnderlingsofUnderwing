...
public class FieldSpaceFactory {
    ...
    private static final DrawChoice[] fieldColors = {RED, BLUE, YELLOW, ORANGE, BLUE, RED, YELLOW, PURPLE, YELLOW, BLUE,
            RED, BLACK, ORANGE, RED, BLUE, YELLOW, GREEN, BLUE, RED, YELLOW, PURPLE, GREEN};
