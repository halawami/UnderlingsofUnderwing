...
public class HatchingGroundTests {
  ...
  public void testAddElementsToAllAdjacentEggsEffectOneColor() {
    ...
    secondAdjacentCard.elementSpaces = new ElementSpace[]{secondCardFirstElementSpace,
    ...
    EasyMock.expect(
        mockElementSpaceLogic.getPlayableSpaces(Arrays.asList(elementColorsToAdd), adjacentCard))
        .andReturn(Arrays.asList(firstMockElementSpace, secondMockElementSpace));
    EasyMock.expect(mockElementSpaceLogic
        .getPlayableSpaces(Arrays.asList(elementColorsToAdd), secondAdjacentCard))
        .andReturn(Arrays.asList(secondCardFirstElementSpace, secondCardSecondMockElementSpace));
    ...
    EasyMock.replay(mockHatchingGround, mockElementSpaceLogic, firstMockElementSpace,
        secondMockElementSpace, secondCardFirstElementSpace, secondCardSecondMockElementSpace,
