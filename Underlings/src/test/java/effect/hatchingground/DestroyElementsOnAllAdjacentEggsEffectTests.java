...
import card.Card;
import card.effect.wild.DestroyAllElementsOnAllAdjacentEggsEffect;
import card.effect.wild.DestroyElementsOnAllAdjacentEggsEffect;
import card.effect.wild.DestroyOneElementsOnAllAdjacentEggsEffect;
...
public class DestroyElementsOnAllAdjacentEggsEffectTests {
    ...
    public void testApplyOneElementColor() {
        ...
        DestroyElementsOnAllAdjacentEggsEffect testedEffect =
                EasyMock.partialMockBuilder(DestroyElementsOnAllAdjacentEggsEffect.class)
