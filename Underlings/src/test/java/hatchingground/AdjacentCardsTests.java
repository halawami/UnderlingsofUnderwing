...
public class AdjacentCardsTests {
    ...
    public void testTopEdgeCard() {
        ...
        assertTrue(returnedCards.contains(mockedCards[0][0]));
        assertTrue(returnedCards.contains(mockedCards[1][1]));
        assertTrue(returnedCards.contains(mockedCards[0][2]));
    }
    ...
    public void testBottomEdgeCard() {
        ...
        assertTrue(returnedCards.contains(mockedCards[2][1]));
        assertTrue(returnedCards.contains(mockedCards[3][2]));
    }
    ...
    public void testRightEdgeCard() {
        ...
        assertTrue(returnedCards.contains(mockedCards[1][2]));
        assertTrue(returnedCards.contains(mockedCards[2][3]));
    }
