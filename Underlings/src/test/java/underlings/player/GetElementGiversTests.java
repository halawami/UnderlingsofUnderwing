...
public class GetElementGiversTests {
  ...
  public void testTwoHandlersTwoElementGiversTwoCards() {
    ...
    EasyMock.expect(mockHandlerFactory.createHandler()).andReturn(handler).times(2);
    EasyMock.expect(elementGiverCard1.getElementGivers())
        .andReturn(Arrays.asList(effectElementGiver1));
    EasyMock.expect(elementGiverCard2.getElementGivers())
        .andReturn(Arrays.asList(effectElementGiver2));

    EasyMock.replay(mockHandlerFactory, handler.elementGiver, effectElementGiver1,
        effectElementGiver2, elementGiverCard1, elementGiverCard2);
    ...
    EasyMock.verify(mockHandlerFactory, handler.elementGiver, effectElementGiver1,
        effectElementGiver2, elementGiverCard1, elementGiverCard2);
  }
